...
Il programma legge da tastiera una serie di numeri interi > -1 e dopo ogni lettura stampa "crescente" se il nuovo valore è maggiore o uguale al precedente   e "decrescente" altrimenti (si assuma che il primo numero inserito sia sia sempre crescente).
